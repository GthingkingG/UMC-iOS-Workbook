...
@Observable
class CotentViewModel {
    var userData: UserData?
    let provider: MoyaProvider<UserRouter>
    let loginProvider: MoyaProvider<AuthRouter>
    
    init(provider: MoyaProvider<UserRouter> = APIManager.shared.createProvider(for: UserRouter.self), loginProvider: MoyaProvider<AuthRouter> = APIManager.shared.createProvider(for: AuthRouter.self)) {
