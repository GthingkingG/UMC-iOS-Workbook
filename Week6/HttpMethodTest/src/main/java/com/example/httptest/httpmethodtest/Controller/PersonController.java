...
public class PersonController {
    ...
    @PostMapping
    public String createPerson(@RequestBody Person person, @RequestHeader(value =  "Authorization", required = false) String authorization) {
    ...
    @GetMapping
    public Person getPerson(@RequestParam String name, @RequestHeader(value = "Authorization", required = false) String authorization) {
        validateAccessToken(authorization);
    ...
    @PutMapping
    public String updatePerson(@RequestBody Person updatePerson, @RequestHeader(value = "Authorization", required = false) String authorization) {
        validateAccessToken(authorization);
    ...
    @PatchMapping
    public String patchPerson(@RequestBody Person partialPerson, @RequestHeader(value = "Authorization", required = false) String authorization) {
        validateAccessToken(authorization);
    ...
    @DeleteMapping
    public String deletePerson(@RequestParam String name, @RequestHeader(value = "Authorization", required = false) String authorization) {
        validateAccessToken(authorization);
